...
$data = array('secret' => '6Ldb3HgbAAAAAPNixfFhN2lCXzDtb6TP1CmPrNoB', 'response' => $_POST['g-recaptcha-response']);
				  ...
				  <div class="icon-box-content table-cell pt-5 mt-5">
                    ...
                    <div class="col-md-6 mb-3 pt-5">
                      <div class="form-group"> 
					   ...
					   <div class="col-md-12">
                      <div class="form-group">
					<div class="g-recaptcha" data-sitekey="6Ldb3HgbAAAAAPADvHUkb1BfmU8V2n07IsesZZj5"></div>
					</div>
					</div>      
