...
if(array_key_exists("password",$_REQUEST)){
	...
	The Password lenght must be between at least 6 & 10 Characters and mus Contain at Least 1 Capital Letter!
         ...
         $query2 = sprintf("update tbl_user_info set password = %s where id = %s",						
						            GetSQLValueString(MD5($_REQUEST["password"]), "text"),
									GetSQLValueString($_REQUEST["user-id"], "int"));
...
<main class="pl-1 pt-1">
    <div class="container">
		...
		<input name="user-id" type="hidden" id="user-id" value="<?php echo $_SESSION["id"]; ?>">
