...
if(checkCaptcha($_POST['g-recaptcha-response'])) {
		// insert 
			         $query2 = sprintf("insert into tbl_booking_info(room_id,room_type_id, noofnights,checkinDate, checkoutDate, title, first_name, last_name,country_id, phone_code, phone_number,email,s_request,BookingNumber,room_price,security_deposit,status_id) values(%s, %s, %s, %s, %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", 
...
echo " <div class='container pt-5 mt-5'> 	
	...
	echo "<div class='container pt-5 mt-5'> 	
			<div class='alert alert-danger pt-5 mt-5' role='alert'>
				<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
